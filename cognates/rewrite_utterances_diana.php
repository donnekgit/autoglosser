...
{
	$oldutt="(".$row->utterance_id.") ".$row->surface;
	$cleanutt=lineclean_surface($row->surface);
	$newutt=lineclean_im_diana($cleanutt);
	
	$newutt=preg_replace("/^ +/u", "", $newutt);  // Fix spaces at beginning of line.
