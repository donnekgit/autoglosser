...
// This file creates a new table of mixed-language entries from the mc_siarad, mc_patagonia or mc_miami tables, and then writes them out with full context detail. The relevant subset has to be specified as the first argument, eg php mc_context.php <patagonia>.
...
$sql1=query("select * from $mcout where use='k' order by filename");
