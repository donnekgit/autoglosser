...
drop_existing_table(insertion_singleword_analysis);

$sql_table = "
CREATE TABLE insertion_singleword_analysis (
...
$sql_pkey = "
ALTER TABLE ONLY insertion_singleword_analysis ADD CONSTRAINT insertion_singleword_analysis_pk PRIMARY KEY (insertion_id);
";
