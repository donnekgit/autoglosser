...
drop_existing_table(insertion_multiword_analysis);

$sql_table = "
CREATE TABLE insertion_multiword_analysis (
    insertion_id serial NOT NULL,
    slotlg character varying(50),
    clause_id integer,
    utterance_id integer,
    filename character varying(50),
    insertion character varying(100),
    length integer,
...
$sql_pkey = "
ALTER TABLE ONLY insertion_multiword_analysis ADD CONSTRAINT insertion_multiword_analysis_pk PRIMARY KEY (insertion_id);
";
